...
import { LayoutDashboard, Bot, Zap, LogOut, ChevronRight, Menu, ChevronDown, CreditCard, GraduationCap, Sparkles, Puzzle } from 'lucide-react'
...
export default function AppLayoutClient({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: '/extension', label: 'Extension LinkedIn & Indeed', icon: Puzzle },
    { href: '/cv-builder', label: 'CV Express', icon: Zap },
