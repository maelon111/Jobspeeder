...
const howToSchema = {
  ...
  step: [
    ...
    { '@type': 'HowToStep', position: 2, name: 'Optimisation IA',            text: "GPT-4o analyse et réécrit votre CV pour maximiser votre score ATS et attirer les recruteurs." },
    { '@type': 'HowToStep', position: 3, name: 'Candidatures automatiques',  text: "Notre bot postule aux offres correspondant à vos critères — emails, LinkedIn, sites carrière — 24h/24." },
  ],
}
